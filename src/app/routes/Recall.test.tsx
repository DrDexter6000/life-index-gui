  ...
  useTranslation: () => ({
    t: (key: string) => {
      const map: Record<string, string> = {
        ...
        recallTabAI: 'AI+',
        agentBridgeQueryPlaceholder: 'Ask about your journal...',
        agentBridgeQuerySubmit: 'Ask',
        agentBridgeQueryEmpty: 'Enter a question to ask the Host Agent',
        agentBridgeProbeLoading: 'Connecting...',
        agentBridgeHostUnavailable: 'Host agent unavailable',
        agentBridgeTabUnavailable: 'AI+ unavailable - Host Agent not connected',
        agentBridgeStreamThinking: 'Thinking through evidence',
        agentBridgeStreamThinkingPending: 'Waiting for Host Agent reasoning...',
        agentBridgeStreamThinkingUnavailable: 'Host Agent did not provide displayable reasoning for this turn.',
        ...
        agentBridgeStreamErrorBody: 'The Host Agent could not complete this request.',
        agentBridgeThinkingToggle: 'Thinking process',
      };
      return map[key] ?? key;
    },
    lang: 'en',
